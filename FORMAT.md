# Формат файлов с вопросами для Cloudtest
...
Можешь использовать такой промпт (CLI/Claude/Cursor):

```
Создай файл с вопросами для Cloudtest в многоуровневом формате.
