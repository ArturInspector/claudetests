...
Локальная веб-платформа для практики технических интервью по blockchain разработке (Solidity, Web3, Python) и другим темам.
...
Используй нейронку (например, Claude) для генерации файлов с вопросами в таком формате:
...
Текст вопроса с примерами кода:
\`\`\`solidity
...
### 1. Генерация вопросов с Claude

Попроси Claude создать файл вопросов:

> Создай .md файл с 10 вопросами для подготовки к интервью по Solidity. Включи вопросы разной сложности (Easy, Medium, Hard) с примерами кода и подробными ответами. Используй формат из README.

### 2. Импорт в платформу

Сохрани файл и загрузи через веб-интерфейс на главной странице.

### 3. Практика

1. Выбери тему
2. Читай вопрос
3. Пиши свой ответ (текстом или кодом)
...
MIT - делай что хочешь, это для твоего роста 🚀
